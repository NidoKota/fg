...
namespace fg
{
    ...
    public:
        ...
        // リソースアクセス用のpublicメソッド
        const std::vector<const resource_base *>& creates() const
        {
            return creates_;
        }
        const std::vector<const resource_base *>& reads() const
        {
            return reads_;
        }
        const std::vector<const resource_base *>& writes() const
        {
            return writes_;
        }
